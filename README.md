...
Azure Data Engineer focused on building **scalable data platform and high-performance ETL Pipelines** across the Morden cloud environments.

Experienced in **Azure Data Factory, ADLS Gen2, Azure SQL, Synapse Analytics**,
Databricks: **PySpark, Delta Lake, Unity Catalog**,
Data Engineering: **ETL/ELT, Incremental Data Loading, Medallion Architecture**,
Programming: **SQL, PySpark, Python** and
**Data Modeling**: Star Schema, Fact & Dimension Tables to design relible, optimized and production ready Data-Solutions.
...
| **LinkedIn** | **Email** |
|--------|--------|
| https://www.linkedin.com/in/suma-math | sumamath50@gmail.com | 
